(function () {
  ...
  const PRO_TEMPLATES = [
    ...
    },
    {
      ...
      aiPrompt: "Use a Shopify boutique/fashion drop layout. Generate a drop name, slogan, collection titles, product microcopy, lookbook copy, and visual CTAs based on the brand style.",
      catalogModel: {
        ...
        collectionLayout: "hero drop, featured collection, lookbook banners, new arrivals grid",
      ...
      visualDifference: "Editorial fashion layout with drop storytelling, lookbook sections, collection banners and visual product cards.",
      ...
      editableSlots: ["drop name", "slogan", "collections", "lookbook images", "products", "sizes/colors", "CTAs", "social proof"],
    },
    {
