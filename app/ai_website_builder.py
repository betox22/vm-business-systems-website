        ...
        input=[
            {
                ...
                "content": (
                    ...
                    "then produce a complete editable site. Templates are reference architectures used to "
                    "save time, not fixed mockups and not copy sources. Use them for layout rhythm, page "
                    "types, catalog model, and section families, then adapt the content and brand direction "
                    "to the business. "
                    ...
                    "Use selectedTemplate only as the base architecture when provided. Preserve its core "
