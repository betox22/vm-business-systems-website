...
const LANDING_COPY = {
  en: {
    ...
    subtitle:
      "Show Luma your business idea, brand, products, services and goals. Luma chooses the right structure, prepares copy and catalog details, then hands you an editable draft.",
    ...
    guideTitle: "Luma collects the details and builds the first draft.",
    guideText: "Answer naturally. Luma detects what is missing, suggests the best template and keeps the final site editable.",
    guideStep1: "Understands your business",
    guideStep2: "Chooses the right template",
    guideStep3: "Drafts pages, sections and catalog",
    examplesKicker: "What Luma can build",
    examplesTitle: "Real starting points, adapted by AI to each business.",
    examplesText: "These are not fixed forms. They are structured bases Luma can choose, rewrite and personalize around the client's industry, tone, catalog and goals.",
    ...
    cardMarketplaceTitle: "Amazon-style store",
    cardMarketplaceText: "Large catalog, departments, offers and fast product discovery.",
    cardPremiumTitle: "Apple-style product launch",
  ...
  es: {
    ...
    subtitle:
      "Muestrale a Luma tu idea de negocio, marca, productos, servicios y objetivos. Luma elige la estructura correcta, prepara textos y catalogo, y te entrega un borrador editable.",
    ...
    guideTitle: "Luma recopila los detalles y construye el primer borrador.",
    guideText: "Responde de forma natural. Luma detecta lo que falta, sugiere la mejor plantilla y mantiene la pagina editable.",
    guideStep1: "Entiende tu negocio",
    guideStep2: "Elige la plantilla correcta",
    guideStep3: "Crea paginas, secciones y catalogo",
    examplesKicker: "Lo que Luma puede crear",
    examplesTitle: "Puntos de partida reales, adaptados por IA a cada negocio.",
    examplesText: "No son formularios fijos. Son bases estructuradas que Luma puede elegir, reescribir y personalizar segun industria, tono, catalogo y objetivos.",
  ...
  fr: {
    ...
    subtitle:
      "Expliquez à Luma votre idée, votre marque, vos produits, vos services et vos objectifs. Luma choisit la bonne structure, prépare les textes et le catalogue, puis livre un brouillon modifiable.",
    ...
    guideTitle: "Luma collecte les détails et construit le premier brouillon.",
    guideText: "Répondez naturellement. Luma détecte ce qui manque, suggère le meilleur template et garde le site modifiable.",
    guideStep1: "Comprend votre activité",
    guideStep2: "Choisit le bon template",
    guideStep3: "Crée pages, sections et catalogue",
    examplesKicker: "Ce que Luma peut créer",
    examplesTitle: "Des bases réelles, adaptées par IA à chaque activité.",
    examplesText: "Ce ne sont pas des formulaires fixes. Ce sont des structures que Luma peut choisir, réécrire et personnaliser selon l'industrie, le ton, le catalogue et les objectifs.",
    ...
    cardMarketplaceTitle: "Boutique style Amazon",
    cardMarketplaceText: "Grand catalogue, rayons, offres et découverte rapide.",
    cardPremiumTitle: "Lancement style Apple",
  ...
  pt: {
    ...
    subtitle:
      "Mostre para a Luma sua ideia, marca, produtos, serviços e objetivos. A Luma escolhe a estrutura certa, prepara textos e catálogo, e entrega um rascunho editável.",
    ...
    guideTitle: "A Luma coleta os detalhes e cria o primeiro rascunho.",
    guideText: "Responda naturalmente. A Luma detecta o que falta, sugere o melhor template e mantém o site editável.",
    guideStep1: "Entende seu negócio",
    guideStep2: "Escolhe o template certo",
    guideStep3: "Cria páginas, seções e catálogo",
    examplesKicker: "O que a Luma pode criar",
    examplesTitle: "Pontos de partida reais, adaptados por IA a cada negócio.",
    examplesText: "Não são formulários fixos. São bases estruturadas que a Luma pode escolher, reescrever e personalizar conforme indústria, tom, catálogo e objetivos.",
    ...
    cardMarketplaceTitle: "Loja estilo Amazon",
    cardMarketplaceText: "Catálogo grande, departamentos, ofertas e descoberta rápida.",
    cardPremiumTitle: "Lançamento estilo Apple",
