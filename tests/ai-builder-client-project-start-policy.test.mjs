...
test("OAuth account switch captures its request epoch after the reset", () => {
...
test("template preview palette lookup cannot abort guided intake during a mixed bundle load", () => {
