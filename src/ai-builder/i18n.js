export const I18N = {
  en: {
    ...
    clientAccountGateKicker: "Your creative workspace",
    clientAccountGateTitle: "Create and manage with LYRA",
    clientAccountGateText: "Sign in with Google to create, resume, or edit your pages.",
    clientAccountEntryTitle: "Enter your workspace",
    clientAccountEntryText: "Your pages and projects are linked to your account.",
  ...
  es: {
    ...
    clientAccountGateKicker: "Tu espacio creativo",
    clientAccountGateTitle: "Crea y gestiona con LYRA",
    clientAccountGateText: "Accede con Google para crear, retomar o editar tus páginas.",
    clientAccountEntryTitle: "Entra a tu espacio",
    clientAccountEntryText: "Tus páginas y proyectos están vinculados a tu cuenta.",
  ...
  fr: {
    ...
    clientAccountGateKicker: "Votre espace créatif",
    clientAccountGateTitle: "Créez et gérez avec LYRA",
    clientAccountGateText: "Connectez-vous avec Google pour créer, reprendre ou modifier vos pages.",
    clientAccountEntryTitle: "Accédez à votre espace",
    clientAccountEntryText: "Vos pages et vos projets sont liés à votre compte.",
  ...
  pt: {
    ...
    clientAccountGateKicker: "Seu espaço criativo",
    clientAccountGateTitle: "Crie e gerencie com LYRA",
    clientAccountGateText: "Entre com o Google para criar, retomar ou editar suas páginas.",
    clientAccountEntryTitle: "Entre no seu espaço",
    clientAccountEntryText: "Suas páginas e projetos estão vinculados à sua conta.",
