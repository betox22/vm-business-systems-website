...
const cases = [
  ...
  { id: 'b2b-saas-enterprise-pro--home--enterprise-hero', archetype: 'b2b', heading: 'Operaciones conectadas',
    copy: {"eyebrow":"B2B SaaS / Enterprise","headline":"Operaciones conectadas","subtitle":"Conoce la propuesta de B2B SaaS / Enterprise","primary_button":"Explorar","primary_page_key":"catalog","secondary_button":"Contacto","secondary_page_key":"contact","image_alt":"Imagen de B2B SaaS / Enterprise"}, images: { image_1: image('enterprise') } },
  { id: 'b2b-saas-enterprise-pro--home--hero', archetype: 'b2b', heading: 'Tu plataforma, tu equipo',
    copy: {"eyebrow":"B2B SaaS / Enterprise","headline":"Tu plataforma, tu equipo","subtitle":"Conoce la propuesta de B2B SaaS / Enterprise","primary_button":"Explorar","primary_page_key":"catalog","secondary_button":"Contacto","secondary_page_key":"contact","image_alt":"Imagen de B2B SaaS / Enterprise"}, images: { image_1: image('b2b-alt') } },
  { id: 'digital-products-store--home--digital-hero', archetype: 'digital', heading: 'Herramientas digitales',
    copy: {"eyebrow":"Digital Products","headline":"Herramientas digitales","subtitle":"Conoce la propuesta de Digital Products","primary_button":"Explorar","primary_page_key":"catalog","secondary_button":"Contacto","secondary_page_key":"contact","image_alt":"Imagen de Digital Products"}, images: { image_1: image('digital') } },
  { id: 'education-course-academy-pro--home--academy-hero', archetype: 'education', heading: 'Aprende a tu ritmo',
    copy: {"eyebrow":"Course Academy","headline":"Aprende a tu ritmo","subtitle":"Conoce la propuesta de Course Academy","primary_button":"Explorar","primary_page_key":"catalog","secondary_button":"Contacto","secondary_page_key":"contact","image_alt":"Imagen de Course Academy"}, images: { image_1: image('academy') } },
  { id: 'fashion-drop-pro--home--fashion-hero', archetype: 'fashion', heading: 'Una nueva colección',
    copy: {"eyebrow":"Fashion Drop","headline":"Una nueva colección","subtitle":"Conoce la propuesta de Fashion Drop","primary_button":"Explorar","primary_page_key":"catalog","secondary_button":"Contacto","secondary_page_key":"contact","image_alt":"Imagen de Fashion Drop"}, images: { image_1: image('fashion') } },
  { id: 'legal-professional-services-pro--home--professional-hero', archetype: 'professional_services', heading: 'Asesoría profesional',
    copy: {"eyebrow":"Legal / Professional","headline":"Asesoría profesional","subtitle":"Conoce la propuesta de Legal / Professional","primary_button":"Explorar","primary_page_key":"catalog","secondary_button":"Contacto","secondary_page_key":"contact","image_alt":"Imagen de Legal / Professional"}, images: { image_1: image('legal') } },
  { id: 'manufacturing-industrial-supplier-pro--home--industrial-hero', archetype: 'industrial', heading: 'Soluciones industriales',
    copy: {"eyebrow":"Industrial Supplier","headline":"Soluciones industriales","subtitle":"Conoce la propuesta de Industrial Supplier","primary_button":"Explorar","primary_page_key":"catalog","secondary_button":"Contacto","secondary_page_key":"contact","image_alt":"Imagen de Industrial Supplier"}, images: { image_1: image('industrial') } },
  { id: 'medical-wellness-clinic-pro--home--clinic-hero', archetype: 'medical', heading: 'Atención a tu medida',
    copy: {"eyebrow":"Clinic / Wellness","headline":"Atención a tu medida","subtitle":"Conoce la propuesta de Clinic / Wellness","primary_button":"Explorar","primary_page_key":"catalog","secondary_button":"Contacto","secondary_page_key":"contact","image_alt":"Imagen de Clinic / Wellness"}, images: { image_1: image('clinic') } },
  { id: 'mega-marketplace--deals--deals-hero', archetype: 'marketplace', heading: 'Oportunidades de hoy',
    copy: {"eyebrow":"Mega Marketplace","headline":"Oportunidades de hoy","subtitle":"Conoce la propuesta de Mega Marketplace","primary_button":"Explorar","primary_page_key":"catalog","secondary_button":"Contacto","secondary_page_key":"contact","image_alt":"Imagen de Mega Marketplace","search_label":"Buscar"}, images: { image_1: image('market-deals') } },
  { id: 'mega-marketplace--home--marketplace-hero', archetype: 'marketplace', heading: 'Explora el catálogo',
    copy: {"eyebrow":"Mega Marketplace","headline":"Explora el catálogo","subtitle":"Conoce la propuesta de Mega Marketplace","primary_button":"Explorar","primary_page_key":"catalog","secondary_button":"Contacto","secondary_page_key":"contact","image_alt":"Imagen de Mega Marketplace","search_label":"Buscar"}, images: { image_1: image('market-home') } },
  { id: 'premium-product-store--home--premium-hero', archetype: 'premium_product', heading: 'Objetos seleccionados',
    copy: {"eyebrow":"Premium Product","headline":"Objetos seleccionados","subtitle":"Conoce la propuesta de Premium Product","primary_button":"Explorar","primary_page_key":"catalog","secondary_button":"Contacto","secondary_page_key":"contact","image_alt":"Imagen de Premium Product"}, images: { image_1: image('premium') } },
  { id: 'real-estate-listings-pro--home--listing-hero', archetype: 'real_estate', heading: 'Encuentra tu próximo espacio',
    copy: {"eyebrow":"Real Estate / Listings","headline":"Encuentra tu próximo espacio","subtitle":"Conoce la propuesta de Real Estate / Listings","primary_button":"Explorar","primary_page_key":"catalog","secondary_button":"Contacto","secondary_page_key":"contact","image_alt":"Imagen de Real Estate / Listings","search_label":"Buscar"}, images: { image_1: image('listing') } },
  {
