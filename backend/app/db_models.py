...
class Lead(Base):
    ...
    id: Mapped[str] = mapped_column(primary_key=True, default=lambda: _id("lead"))
    business_name: Mapped[str]
    tax_id: Mapped[str] = mapped_column(default="")
    contact_name: Mapped[str]
    contact_email: Mapped[str] = mapped_column(default="")
    phone: Mapped[str]
    solution_type: Mapped[str]
    location: Mapped[str]
    assigned_representative: Mapped[str] = mapped_column(default="")
    comment: Mapped[str] = mapped_column(Text, default="")
    notification_status: Mapped[str] = mapped_column(default="not_configured")
    created_at: Mapped[int] = mapped_column(default=_now, index=True)
