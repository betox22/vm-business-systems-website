(function () {
  ...
  const INTENT_RULES = [
    ...
    },
    {
      ...
      catalogType: "legal_professional_services_catalog",
      keywords: ["abogado", "lawyer", "legal", "law firm", "firma legal", "contador", "accountant", "tax", "taxes", "impuestos", "consulting", "consultoria", "consultoría", "seguros", "insurance", "asesor", "advisor", "financiero", "financial", "b2b", "empresa", "compliance", "inmigracion", "inmigración", "real estate attorney", "contracts", "contratos", "bookkeeping", "payroll", "nomina", "nómina", "firma profesional", "professional firm"],
    },
    {
